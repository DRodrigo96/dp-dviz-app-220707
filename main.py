...
app.layout = html.Div(children=[
    ...
    dcc.Graph(id='barvertical', figure=fig_bv, style=squared_style)
])

@app.callback(Output('description', 'children'), Input('submit-button', 'n_clicks'), State('country-list', 'value'), State('year-list', 'value'))
